...
// Renders as the 19th onboarding screen ("Identity Setup"). Returning users
// aren't handled here — they go through the same phone/OTP step as anyone
// else (OtpVerification, later in this flow), which already detects an
// existing account and restores it straight to the dashboard instead of
// re-running onboarding. Keeping exactly one phone-auth implementation
// avoids two flows fighting over the same reCAPTCHA verifier.
            ...
            <main className="flex-1 flex flex-col items-center gap-8 py-2">
                ...
                <div className="w-full flex flex-col gap-5 mt-2">
                    {[
                        ...
                        { label: 'Phone Number', key: 'phone' as const, placeholder: '+91...', type: 'tel' },
                    ].map((field) => (

  ...
  return (
    <div className="flex flex-col min-h-[85vh] justify-between py-2">
      <header className="text-left mb-6">
        <div className="text-[10px] font-black tracking-[3px] text-primary uppercase mb-3">10 / 20</div>
      ...
      <footer className="mt-8 flex flex-col gap-2">
        <p className="text-center text-[11px] font-bold italic text-white/50 mb-2">

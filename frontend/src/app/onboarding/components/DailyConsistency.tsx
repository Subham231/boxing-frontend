    ...
    return (
        <div className="flex flex-col min-h-[85vh] justify-between py-2">
            <header className="text-left mb-6">
                <div className="text-[10px] font-black tracking-[3px] text-primary uppercase mb-3">08 / 12</div>
                    ...
                    <div className="flex justify-between">
                        {DAYS.map((d, i) => (
                            <div key={i} className="flex flex-col items-center gap-1.5">
                                ...
                                <div
                                    className={`w-8 h-8 rounded-full flex items-center justify-center ${DONE[i] ? 'bg-primary text-black' : 'bg-white/5 text-white/20 border border-white/10'
                                        }`}
                                >

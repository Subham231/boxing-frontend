    ...
    return (
        <div className="flex flex-col min-h-[85vh] justify-between py-2">
            <header className="text-left mb-6">
                <div className="text-[10px] font-black tracking-[3px] text-primary uppercase mb-3">07 / 12</div>
                ...
                {CARDS.map((c, i) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className="glass-card p-5 rounded-3xl border-white/5 bg-black/40 flex flex-col items-center gap-2 text-center"
                        >

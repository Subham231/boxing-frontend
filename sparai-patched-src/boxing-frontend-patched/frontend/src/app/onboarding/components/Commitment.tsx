        ...
        <div className="flex flex-col min-h-[85vh] justify-between py-2">
            ...
            <main className="flex-1 flex flex-col items-center justify-center gap-4">
                <div className="w-full relative">
                    <input
                        ...
                        className="w-full bg-transparent border-b-2 border-primary/20 focus:border-primary text-center text-4xl font-black py-4 outline-none tracking-widest placeholder:opacity-10 transition-all uppercase text-white"
                        autoFocus
                    />
                    <div className="text-center text-[9px] uppercase tracking-[0.3em] text-primary/40 font-mono mt-4">
            ...
            <footer className="mt-8 flex flex-col gap-4">
                <button
                    ...
                    className="btn-primary w-full h-16 flex items-center justify-center gap-2 disabled:opacity-40"
                >
